...
@app_pages.route('/states/<state_id>/cities', methods=['GET'],
...
@app_pages.route('/cities/<city_id>/', methods=['GET'], strict_slashes=False)
...
@app_pages.route('/cities/<city_id>', methods=['DELETE'], strict_slashes=False)
...
@app_pages.route('/states/<state_id>/cities', methods=['POST'],
                 strict_slashes=False)
...
@app_pages.route('/cities/<city_id>', methods=['PUT'], strict_slashes=False)
